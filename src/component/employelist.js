   ...
   return (
        <div>
            <div className='bg-blue-600 h-[100px] relative '>
                ...
                <button className='text-right w-[180px] bg-white hover:bg-green-400 text-gray-800 font-semibold py-2 px-4 border border-gray-400 rounded shadow absolute top-[20px] left-[5px]'>CREATE EMPLOYEE</button>
                <i className='absolute top-[26px] left-[5px]'><AddCircleIcon/></i>
                </Link>
                <Link to={'/'}>
                <button className='w-[100px] text-right bg-white hover:bg-red-500 text-gray-800 font-semibold py-2 px-2 border border-gray-400 rounded shadow absolute top-[20px] right-[5px]'>LOGOUT</button>
                <i className='absolute top-[27px] right-[80px]'><LogoutIcon/></i> 
                </Link>
                    ...
                    <tbody>
                        {
                           ...
                           empdata.map(item=>(
                                    ...
                                    <button onClick={()=>Deletefunction(item.id)} className='p-4 hover:bg-red-500 rounded'><i><PersonRemoveIcon/></i></button>
                                            </td>
                                         </tr>
