...
const Loginform=()=>{
   //for navigation to employe details
    ...
    return(
        ...
        <div className=" bg-white h-screen   flex flex-col  justify-center items-center sm: overflow-scroll"> 
            ...
            <div className="bg-white rounded-md shadow-lg relative">
                 ...
                 <i onClick={Changetype} className="cursor-pointer absolute top-[182px] left-[290px] ">{passwordtype==="password"?< VisibilityOffIcon/>:<VisibilityIcon/>}</i>
